...
public class Pmediana {
	public static void main (String[] args) {
		...
		try {
			//Leitura dos dados
			double [][] matriz =  {{0, 400.00, 1300.00, 1700.00, 282.84, 1513.27, 400.00, 565.69, 1360.15, 1746.42, 2400.00, 2433.11, 2729.47, 2941.09, 2607.68, 3001.67, 2800.00, 2828.43, 3087.07, 3275.67},
			...
			for (int i = 0; i < N; i++) {
				...
				//x[i]= cplex.numVarArray(N, 0, 1, IloNumVarType.Int);
			}
			...
			for (int i = 0; i < N; i++) {
				for (int j = 0; j < N; j++) {
					if(i!=j) {
						cplex.add(cplex.addLe(x[i][j], x[j][j]));	
					}
